            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 24, marginBottom: 24 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div>
                  ...
                  <div style={{ color: '#222', fontWeight: 600, fontSize: 15 }}>Project approved and published</div>
                </div>
              </div>
              <div style={{ minWidth: 400, display: 'flex', flexDirection: 'column', gap: 24 }}>
                <input value="Project approved and published" readOnly style={{ width: '100%', padding: 12, borderRadius: 24, border: '2px solid #eee', fontSize: 15 }} />
              </div>
            </div>
          </div>
        )}
